      ...
      <div className="container-x relative z-10">
        <Reveal>
          ...
          >
            <div
              aria-hidden
              className="pointer-events-none absolute -right-16 -top-20 h-64 w-64 rounded-full bg-cyan/20 blur-3xl"
            />
            <div
              aria-hidden
              className="pointer-events-none absolute -bottom-24 -left-16 h-64 w-64 rounded-full bg-green/15 blur-3xl"
            />
            <div className="relative mx-auto max-w-2xl">
              ...
              <p className="mx-auto mt-4 max-w-xl text-[1.02rem] leading-relaxed text-white/75">
                {text}
              </p>
