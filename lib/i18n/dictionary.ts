...
const tr = {
  ...
  contact: {
    ...
    form: {
      ...
      submit: "Gönder",
      success: "Teşekkürler! Mesajınız hazır — göndermek için e-posta uygulamanız açılacak.",
    },
    info: {
      emailLabel: "E-posta",
...
const en: typeof tr = {
  ...
  contact: {
    ...
    form: {
      ...
      submit: "Send",
      success: "Thanks! Your message is ready — your email app will open to send it.",
    },
    info: {
      emailLabel: "Email",
      email: "info@forpus.com",
