...
export const webProjects: WebProject[] = [
  ...
  },
  {
    ...
    desc: {
      tr: "Medikal estetik hekimi için kurumsal tanıtım sitesi: uygulama sayfaları, galeri ve randevu talebi.",
      en: "A corporate site for a medical aesthetics physician: treatment pages, gallery and appointment requests.",
    },
    tags: ["Web", "Kurumsal"],
    accent: "blue",
  },
